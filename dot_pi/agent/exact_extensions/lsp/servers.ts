...
export const SERVER_CONFIGS: ServerConfig[] = [
  ...
  { id: "terraform", label: "Terraform", command: "terraform-ls", args: ["serve"], extensions: [".tf", ".tfvars"], rootMarkers: [".terraform", ".terraform.lock.hcl", ".git"], root: (filePath) => findTerraformModuleRoot(filePath), initializationOptions: tofuPath ? { terraform: { path: tofuPath } } : undefined, languageId: terraformLanguageId, packageContext: terraformPackageContext },
];
