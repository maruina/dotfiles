...
- Create Datadog worktrees under `~/dd/.worktrees/<repo>/<branch-slug>` (matches herdr's layout; `wt.fish` and `herdr worktree create` slug branches as lowercase, slash → dash).
