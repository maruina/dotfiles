...
export function configForFile(filePath: string, configs: ServerConfig[]): ServerConfig | undefined { const ext = extname(filePath); return configs.find((c) => c.extensions.includes(ext)); }
