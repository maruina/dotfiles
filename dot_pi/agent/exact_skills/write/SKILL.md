...
1. **Identify the purpose** - Before editing, determine the main point and intended audience. If the text can't be summarized in one or two sentences, it lacks coherence.
2. **Apply the principles below** in order of impact.
3. **Preserve the author's intent** - Editing refines expression, not meaning.
