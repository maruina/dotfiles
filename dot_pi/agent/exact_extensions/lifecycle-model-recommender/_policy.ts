...
export const LIFECYCLE_POLICY: LifecyclePolicy = {
  "/brainstorm": {
    ...
    increaseQuality: sol("xhigh", "Premium", "Use deeper flagship reasoning for difficult framing."),
  },
  "/plan": {
  ...
  "/systematic-review": {
    ...
    increaseQuality: sol("xhigh", "Premium", "Use adversarial review for high-risk plans."),
  },
  "/execute": {
    ...
    increaseQuality: sol("xhigh", "Premium", "Escalate implementation reasoning for difficult changes."),
  },
  "/verify": {
    ...
    increaseQuality: sol("xhigh", "Premium", "Use deeper review for difficult verification."),
  },
};
